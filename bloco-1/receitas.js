const receitas = [{
    "id": 1,
    "nome": "Espaguete Mediterrâneo",
    "metodoDePreparo": "cozido",
    "ingredientes": ["macarrão espaguete", "azeite", "alho", "sal", "tomate", "queijo ralado", "cebola", "cenoura", "abobrinha", "berinjela", "pimenta-do-reino"],
    "rendimentoPorPorcao": 3,
    "categoria": "Massa",
    "dificuldade": "fácil",
   ...
   "nome": "Salada Grega",
   "metodoDePreparo": "cru",
   "ingredientes": ["pimentão vermelho", "pimentão amarelo", "sal", "azeite", "cebola roxa", "orégano", "tomate", "queijo feta", "azeitona preta", "tomates",  "pepino japonês"],
   "rendimentoPorPorcao": 3,
   "categoria": "Massa",
   "dificuldade": "fácil",
   ...
   "id": 3,
   "nome": "Cachupa",
   "metodoDePreparo": "Refogado",
   "ingredientes": [" carne bovina", "Pé de porco", "bacon", "sal", "chouriço", "milho", "orégano", "feijão", "grão-de-bico", "cebola", "louro",  "batata-doce ","couve ", "mandioca", "sal", "azeite", "pimenta-do-reino"],
   ...
   {
      "id": 4,
      "nome": "Rabanada low carb",
      "metodoDePreparo": "Fritura",
      "ingredientes": [" farinha", "farinha de amêndoa", "fermento químico", "sal", "psyllium", "extrato de baunilha", " canela em pó", "vinagre de maçã", "óleo ou óleo de coco "],
      "rendimentoPorPorcao": 6,
